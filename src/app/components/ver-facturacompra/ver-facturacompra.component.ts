...
export class VerFacturacompraComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.titulo = 'Detalle Factura Compra';
  }
        ...
        content: [
          ...
          { text: 'Comprobante de Compras.', style: 'subheader', margin: [0, 0, 0, 0] },
          {
            ...
            table: {
              ...
              body: [
                [{ text: 'Proveedor\n' + this.prov.razonsocial, style: 'tableHeader', alignment: 'center' },
                ...
                [{ text: this.prov.condicioniva, alignment: 'center' },
                { text: this.prov.cuit, alignment: 'center' },
          ...
          { qr: location.origin + '/verfacturacompra/' + this.factura.id, fit: 100, alignment: 'right' },
          { text: location.origin + '/verfacturacompra/' + this.factura.id, alignment: 'right' }
        ],
        styles: {
          header: {
            fontSize: 18,
